...
namespace _365Plus.Web.Controllers
{
    public class HomeController : BaseController
    {
        ...
        public JsonResult ValidateReferralCode(string code)
        {
            var result = new { Success = "true", Validate= _clientService.ValidateReferralCode(code), Message = "Success" };
           
            return Json(result, JsonRequestBehavior.AllowGet);
        }

        public JsonResult ValidatePromoCode(string code)
        {
            var result = new { Success = "true", Validate = _clientService.ValidatePromoCode(code), Message = "Success" };
