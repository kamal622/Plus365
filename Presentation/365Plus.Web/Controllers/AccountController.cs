        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    return Json(new { SignInStatus = result, Message = "", ReturnUrl = returnUrl }, JsonRequestBehavior.DenyGet);
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return Json(new { SignInStatus = result, Message = "", ReturnUrl = "/" }, JsonRequestBehavior.DenyGet);
