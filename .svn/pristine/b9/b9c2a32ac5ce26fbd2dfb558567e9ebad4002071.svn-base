...
namespace _365Plus.Web.Framework.Controllers
{
    public abstract class BaseController : Controller
    {
        ...
        protected override void Initialize(RequestContext requestContext)
        {
            ...
            //{
            //    var userId = requestContext.HttpContext.User.Identity.GetUserId<int>();
            //    RebindSession(userId);
            //}
            //var CurrentLanguageCode = SessionHelper.Culture;
